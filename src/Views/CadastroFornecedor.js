...
class CadastrarFornecedor extends React.Component {
  ...
  handleTelefone = (e) => {
    console.log("o valor da variavel telefone:", this.state.telefone)
    this.setState({
  ...
  handleWhatsApp = (e) => {
    console.log("o valor da variavel Whats:", this.state.whatsApp)
    this.setState({
  ...
  handlePessoa = (e) => {
    console.log("o valor da variavel pessoa de contato:", this.state.pessoaContato)
    this.setState({
      pessoaContato: e.target.value
    })
  }
  ...
  cadastrar = () => {
    ...
    axios.post("https://engenharia-gestao-hospitalar.herokuapp.com/fornecedor", {
      ...
      pessoaContato: this.state.pessoaContato
